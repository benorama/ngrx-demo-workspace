        ...
        var i =
            ...
            s =
                ((function(t) {
                    ...
                    return (
                        t(document).on(d.CLICK_DATA_API, u.DISMISS, _._handleDismiss(new _())),
                ...
                (function(t) {
                    ...
                    return (
                        t(document).on(m.CLICK_DATA_API, v.DATA_SLIDE, T._dataApiClickHandler),
                            ...
                            return (
                                ...
                                (e.prototype._activate = function(e, n, i) {
                                    var o = this,
                                        ...
                                        a =
                                            i &&
                                            r.supportsTransitionEnd() &&
                                            ((s && t(s).hasClass(d.FADE)) || Boolean(t(n).find(f.FADE_CHILD)[0])),
                                        l = function() {
                                ...
                                (e.prototype._transitionComplete = function(e, n, i, o) {
                                    ...
                                    if (
                                        ...
                                        i ? (r.reflow(e), t(e).addClass(d.SHOW)) : t(e).removeClass(d.FADE),
                                ...
                                (h._jQueryInterface = function(e) {
                                    return this.each(function() {
                                        ...
                                        if (
                                            ...
                                            (n || ((n = new h(this, o)), t(this).data(a, n)), 'string' == typeof e)
                                        ) {
                                            if (void 0 === n[e]) throw new Error('No method named "' + e + '"');
                                            n[e]();
                                        }
                        ...
                        (u._jQueryInterface = function(t) {
                            return this.each(function() {
                                ...
                                if (
                                    ...
                                    (e || ((e = new u(this, n)), r(this).data(h, e)), 'string' == typeof t)
                                ) {
