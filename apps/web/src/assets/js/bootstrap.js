    ...
    var ScrollSpy = (function($) {
        ...
        var ScrollSpy = (function() {
            ...
            ScrollSpy.prototype.refresh = function refresh() {
                ...
                var autoMethod =
                    this._scrollElement !== this._scrollElement.window ? OffsetMethod.POSITION : OffsetMethod.OFFSET;
    ...
    var Tooltip = (function($) {
        ...
        var Tooltip = (function() {
            ...
            Tooltip.prototype.setElementContent = function setElementContent($element, content) {
                ...
                if (
                    (typeof content === 'undefined' ? 'undefined' : _typeof(content)) === 'object' &&
            ...
            Tooltip.prototype._setListeners = function _setListeners() {
                ...
                triggers.forEach(function(trigger) {
                    if (trigger === 'click') {
                        $(_this24.element).on(_this24.constructor.Event.CLICK, _this24.config.selector, function(
                            event
                        ) {
        ...
        var Popover = (function(_Tooltip) {
            ...
            Popover._jQueryInterface = function _jQueryInterface(config) {
                return this.each(function() {
                    var data = $(this).data(DATA_KEY);
                    var _config =
                        (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' ? config : null;
